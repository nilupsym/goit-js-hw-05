...
class Car {
 // Write code under this line
  ...
  set price(value) {this._price = value;}
    ...
    turnOff() {if (this.speed === 0) { this.isOn = false; }}
    accelerate(value) {if (this.speed + value <= this.maxSpeed) {return this.speed += value; } return this.speed = this.maxSpeed;}
    decelerate(value) {if (this.speed - value >= 0) {return this.speed -= value; } return this.speed = 0;}
    drive(hours) {if (this.isOn) {return this.distance += this.speed * hours;} return this.distance;}
}
